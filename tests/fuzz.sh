...
LLVM_PROFILE_FILE="urltest.profraw" bin/tests/urltest-fuzz -max_total_time=2000 corpus &&
LLVM_PROFILE_FILE="pcm.profraw" bin/tests/pcm-fuzz -max_total_time=2000 corpus &&
